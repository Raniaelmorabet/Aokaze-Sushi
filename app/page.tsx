      ...
      <div className="bg-[#121212] text-white min-h-screen overflow-x-hidden" dir={dir}>
        ...
        <header
            className={`w-full mt-1 py-4 z-50 transition-all duration-300 fixed top-0 bg-[#121212]/90 backdrop-blur-md shadow-lg ${
                isHeaderFixed ? "fixed top-0 bg-[#121212]/90 backdrop-blur-md shadow-lg" : "fixed top-0"
            }`}
        >
          <div className="container mx-auto px-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="text-white">
                <Image src={logo || "/placeholder.svg"} alt="logo" className="w-24 md:w-28 object-cover" />
              </div>
            </div>
                ...
                >
                    ...
                    {notifications.length > 0 ? (
                        ...
                        <span className="text-xs px-2 py-1 bg-gray-800 rounded-full text-gray-400">
                          {notification.type.replace("_", " ")}
                                ...
                                {!notification.isRead && <span className="w-2 h-2 rounded-full bg-orange-500"></span>}
                              </div>
                            </div>
                        ))
                    ) : (
                  ...
                  {notifications.length > 0 && (
                      <div className="p-3 border-t border-gray-700 text-center">
                        <button onClick={() => markAllAsRead()} className="text-sm text-orange-500 hover:text-orange-400">
                          Mark all as read
                        </button>
                      </div>
                  )}
                    ...
                    {offers.map((_, index) => (
                        <button
                            ...
                            className={`w-3 h-3 rounded-full transition-all duration-300 ${
                                index === activePromotion ? "bg-orange-500 w-8" : "bg-gray-600 hover:bg-gray-500"
                            }`}
                        ></button>
                    ))}
                  </div>
                  ...
                  return (
                      ...
                      >
                        ...
                        {categorySlug.includes("appetizer") ? (
                            <Utensils className={activeCategory === categorySlug ? "text-white" : "text-gray-400"} />
                            ...
                            <svg
                                ...
                                className={activeCategory === categorySlug ? "text-white" : "text-gray-400"}
                            >
                            ...
                            <GlassWater className={activeCategory === categorySlug ? "text-white" : "text-gray-400"} />
        ...
        <section id="testimonials" className="container mx-auto px-4 py-20">
          ...
          {serverTestimonials.length === 0 ? (
              ...
              <div className="relative max-w-4xl mx-auto">
                  ...
                  >
                    <div className="w-full flex flex-col justify-center items-center gap-4 -translate-y-14">
                      <div className="w-16 h-16 rounded-full overflow-hidden">
                        <Image
                            src={
                                serverTestimonials[activeTestimonial].user?.image || "/placeholder.svg" || "/placeholder.svg"
                            }
                      ...
                      <div>
                        <p className="font-bold text-lg text-center">{serverTestimonials[activeTestimonial].user?.name}</p>
                    ...
                    <div className="flex justify-center  -translate-y-12 gap-1 mb-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                          <svg
                              ...
                              height="20"
                              viewBox="0 0 24 24"
                              fill={star <= Math.floor(serverTestimonials[activeTestimonial].rate) ? "#facc15" : "none"}
                              stroke="#facc15"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                ...
                <button
                    onClick={() => setActiveTestimonial((prev) => (prev === 0 ? serverTestimonials.length - 1 : prev - 1))}
                ...
                <button
                    onClick={() => setActiveTestimonial((prev) => (prev === serverTestimonials.length - 1 ? 0 : prev + 1))}
              ...
              <div className="flex justify-center mt-8 gap-2">
                {serverTestimonials.map((_, index) => (
                    <button
                        ...
                        className={`w-3 h-3 rounded-full transition-all duration-300 ${
                            index === activeTestimonial ? "bg-orange-500 w-8" : "bg-gray-600 hover:bg-gray-500"
                        }`}
                    ></button>
                ))}
              </div>
          ...
          {isGalleryOpen && (
              ...
              >
                ...
                <button
                    ...
                    onClick={() => setActiveGalleryImage((prev) => (prev === 0 ? gallery.length - 1 : prev - 1))}
                >
                  <ChevronLeft size={32} />
                </button>
                ...
                <button
                    ...
                    onClick={() => setActiveGalleryImage((prev) => (prev === gallery.length - 1 ? 0 : prev + 1))}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-24 mb-16">
              <div>
                <div className="flex items-center gap-2 mb-6">
                  <div className="text-white">
                    <Image src={logo || "/placeholder.svg"} alt={logo} className="w-28"></Image>
                  </div>
