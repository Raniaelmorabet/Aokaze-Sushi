...
export default function TablesPage() {
  ...
  const filteredTables = serverTables.filter((table) => {
    // Location filter
  ...
  const handleDeleteConfirm = async () => {
    try {
      const responce = await tableAPI.deleteTable(selectedTable._id);
      if (responce.success) {
        setServerTables(
          serverTables.filter((table) => table._id !== selectedTable._id)
        );
        setAlertStatus({
          type: responce.success,
      ...
      setAlertStatus({
        type: false,
        message: error.message || "can not remove table",
      });
    }
    // Close the modal
      ...
      <div className="bg-[#1E1E1E] rounded-xl shadow-md overflow-hidden mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
          {filteredTables?.map((table) => (
            <div
              key={table._id}
              className={`bg-[#2a2a2a] rounded-xl overflow-hidden shadow-md ${
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm">
                    {table.minReservationDuration}-
                    {table.maxReservationDuration} min
                  </span>
                </div>
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {table.amenities.map((amenity) => (
                        <span
                          key={amenity}
                          className="px-2 py-1 bg-[#1E1E1E] text-xs rounded-full"
                        >
                ...
                <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-700">
                  ...
                  <button
                    ...
                    } hover:bg-[#333] rounded-lg transition-colors`}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#2a2a2a] p-3 rounded-lg">
                      ...
                      <p className="font-medium">
                        ${selectedTable.pricePerHour}/hour
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-[#2a2a2a] rounded-lg p-4 mb-6">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span>
                          {selectedTable.minReservationDuration} minutes
                        </span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    <div className="bg-[#2a2a2a] rounded-lg p-4 mb-6">
                      <div className="flex flex-wrap gap-2">
                        {selectedTable.amenities.map((amenity) => (
                          <span
                            key={amenity}
                            className="px-3 py-1 bg-[#1E1E1E] rounded-full text-sm"
                          >
                            {getAmenityLabel(amenity)}
                          </span>
                        ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setNewTable({
                            ...newTable,
                            minReservationDuration: Number(e.target.value),
                          })
                        }
                        className="w-full bg-[#2a2a2a] text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500"
                      >
                    ...
                    <div>
                      <label
                        htmlFor="maxReservationDuration"
                        className="block text-sm font-medium text-gray-400 mb-1"
                      >
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setNewTable({
                            ...newTable,
                            maxReservationDuration: Number(e.target.value),
                          })
                        }
                        className="w-full bg-[#2a2a2a] text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500"
                      >
                ...
                <div>
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setNewTable({ ...newTable, isActive: e.target.checked })
                      }
                      className="mr-2"
                    />
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => {
                          setEditingTable({
                            ...editingTable,
                            images: editingTable.images.filter(
                              (_, i) => i !== index
                            ),
                          });
                        }}
            ...
            <div className="p-6">
              ...
              <div className="mt-4 flex justify-between items-center">
                ...
                <p className="text-sm text-gray-400">
                  Tables are positioned according to their X and Y coordinates.
                </p>
              </div>
            </div>
          </div>
