...
const sampleCategories = [
  {
    ...
    name: "Sushi Rolls",
    description:
      "Traditional and fusion sushi rolls with various fillings and toppings.",
    image:
  ...
  },
  {
    ...
    name: "Nigiri",
    description:
      "Hand-pressed sushi with a slice of fish or seafood on top of rice.",
    image:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1562158074-d49fbeffcc91?q=80&w=1200&auto=format&fit=crop",
    isActive: true,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1584583570840-0a3d88497351?q=80&w=1200&auto=format&fit=crop",
    isActive: false,
...
//   const { toast } = useToast();
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      const res = await categoryAPI.deleteCategory(selectedCategory._id);
      if (res.success) {
        setShowCategory(
          showCategory.filter((cat) => cat._id !== selectedCategory._id)
        );
      ...
      >
        <div>
          ...
          <p className="text-gray-400">
            Create, update, and manage menu categories
          </p>
        </div>
      ...
      >
        <div className="bg-[#1E1E1E] rounded-xl p-4 flex items-center">
          ...
          <div>
            ...
            <AnimatedCounter value={showCategory.length} dur={1000} />
          </div>
        </div>
        ...
        <div className="bg-[#1E1E1E] rounded-xl p-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">
              <AnimatedCounter
                value={showCategory.filter((cat) => cat.isActive).length}
                dur={1000}
              />
            </p>
          </div>
          ...
          <AnimatePresence>
            {filteredCategories.map((category, index) => (
              <motion.div
                ...
                layout
                className={`bg-[#1E1E1E] rounded-xl max-h-72 flex flex-col overflow-hidden shadow-md group relative ${
                  ...
                  {uploading && (
                    <div className="mb-6">
                      ...
                      <p className="text-center text-sm text-gray-400 mt-2">
                        Saving category... {uploadProgress}%
                      </p>
                    </div>
                  )}
                ...
                <form onSubmit={handleUpdateCategory}>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      aria-invalid={formErrors.name ? "true" : "false"}
                      aria-describedby={
                        formErrors.name ? "update-name-error" : undefined
                      }
                    />
                    {formErrors.name && (
                      <p
                  ...
                  <div className="mb-4 bg-[#2a2a2a] rounded-lg p-3">
                    <div className="flex justify-between text-xs text-gray-400 mb-1">
                      ...
                      {selectedCategory.updatedAt && (
                        <span>
                          Last Updated: {formatDate(selectedCategory.updatedAt)}
                        </span>
                      )}
                    </div>
                  ...
                  {uploading && (
                    <div className="mb-6">
                      ...
                      <p className="text-center text-sm text-gray-400 mt-2">
                        Updating category... {uploadProgress}%
                      </p>
                    </div>
                  )}
