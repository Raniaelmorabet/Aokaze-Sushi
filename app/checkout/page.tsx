    ...
    try {
      ...
      if (response.ok) {
        ...
        if (response.errors) {
          ...
          setError(response.message || "There was an error processing your order.")
        }
      }
    } catch (err) {
      ...
      <Dialog open={showLoginModal} onOpenChange={setShowLoginModal}>
        <DialogContent className="bg-[#1E1E1E] border-gray-800 text-white sm:max-w-md">
          <DialogHeader className="relative">
            ...
            <DialogTitle className="text-xl font-bold text-center">Account Access</DialogTitle>
          ...
          <Tabs defaultValue="login" value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-2 bg-gray-800">
              <TabsTrigger value="login" className={`${activeTab === 'login' ? '!bg-white !text-black' : ''}`}>Login</TabsTrigger>
              <TabsTrigger value="signup" className={`${activeTab === 'signup' ? '!bg-white !text-black' : ''}`}>Sign Up</TabsTrigger>
            </TabsList>
              ...
              <div className="grid gap-4">
                <div className="relative my-6">
                  ...
                  <div className="relative z-10 flex justify-center text-xs">
                    <span className="bg-[#1E1E1E] px-2 text-gray-400">or continue with email
                    </span>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="signup" className="pt-4">
              <div className="grid gap-4">
                <div className="relative my-6">
                  <Separator
                      className="absolute inset-0 top-1/2 -translate-y-1/2 w-full border-t-[1px] border-white z-0"/>
                  <div className="relative z-10 flex justify-center text-xs">
                    <span className="bg-[#1E1E1E] px-2 text-gray-400">or continue with email
                    </span>
                  </div>
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-2 pt-2">
            ...
            <Button
                ...
                onClick={() => {
                  router.push(`${activeTab === "login" ? "/auth/login" : "/auth/register"}?redirect=checkout`)
                  setShowLoginModal(false)
                }}
            >
        ...
        <header className="bg-[#1a1a1a] py-4 shadow-md">
          <div className="container mx-auto px-4 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              <Image src={logo || "/placeholder.svg"} alt={logo} className="w-24"></Image>
            </Link>
                    ...
                    >
                        ...
                        <div>
                          ...
                          <input
                              ...
                              className={`w-full bg-[#2a2a2a] text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                                  errors.street ? "focus:ring-red-500 border-red-500" : "focus:ring-orange-500"
                              }`}
                              required
                          />
                      ...
                      <div className="mb-6">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full bg-[#2a2a2a] text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                                errors.city ? "focus:ring-red-500 border-red-500" : "focus:ring-orange-500"
                            }`}
                            required
                        />
                      ...
                      <div className="mb-6">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full bg-[#2a2a2a] text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                                errors.state ? "focus:ring-red-500 border-red-500" : "focus:ring-orange-500"
                            }`}
                            required
                        />
                      ...
                      <div className="mb-6">
                        <label className="block text-sm text-gray-400 mb-1">Delivery Instructions</label>
                        <input
                            type="text"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="col-span-2">
                          ...
                          <select
                              ...
                              onChange={handleChange}
                              className={`w-full bg-[#2a2a2a] text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                                  errors.country ? "focus:ring-red-500 border-red-500" : "focus:ring-orange-500"
                              } appearance-none`}
                              required
                          >
                        ...
                        <div>
                          ...
                          <input
                              ...
                              onChange={handleChange}
                              className={`w-full bg-[#2a2a2a] text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                                  errors.zipCode ? "focus:ring-red-500 border-red-500" : "focus:ring-orange-500"
                              }`}
                              required
                          />
                  ...
                  >
                    ...
                    <div className="bg-[#2a2a2a] rounded-lg p-6 mb-8 max-w-md mx-auto">
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="font-medium">{resData.orderNumber || "123456789"}</span>
                      </div>
                      <div className="flex justify-between mb-2">
