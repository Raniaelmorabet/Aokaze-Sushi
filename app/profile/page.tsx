...
export default function ProfilePage() {
    ...
    const filteredOrders = useMemo(() => {
        ...
        return getorders.filter((order) => {
            ...
            // Search in status
            if (getStatusText(order.status).toLowerCase().includes(query)) return true
                                ...
                                {getorders.length === 0 ? (
                                    ...
                                    <div className="space-y-6">
                                        {filteredOrders.length === 0 && searchQuery.trim() !== "" && (
                                            <div className="bg-[#1E1E1E] rounded-xl p-8 text-center">
                                                ...
                                                <p className="text-gray-400 mb-6">No orders match your search for "{searchQuery}"</p>
                                                <button
                                  ...
                                  {getStatusText(order.status)}
                                                        ...
                                                        <div className="mt-2 md:mt-0">
                                                            <p className="text-xl font-bold text-orange-500">${order.totalPrice.toFixed(2)}</p>
                                                            <p className="text-xs text-gray-400 text-right">{order.itemsCount} items</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="relative z-10 flex flex-col items-center">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            {status === "processing" && <Clock size={18} />}
                                                                            {status === "completed" && <CheckCircle size={18} />}
                                                                            {status === "delivered" && <TruckIcon size={18} />}
                                                                        </div>
                                        ...
                                        {reservations.map((reservation) => (
                                            ...
                                            >
                                                <div className="flex justify-between items-start mb-4">
                                                    ...
                                                    <span
                                                        className={`px-2 py-0.5 rounded-full text-xs ${reservation.status === "confirmed" ? "bg-green-500/20 text-green-500" : "bg-yellow-500/20 text-yellow-500"}`}
                                                    >
